    ...
    public partial class YeniSevkForm : Sağlık_Ocağı_HTS.Formlar.DialogBox
    {
        ...
        public YeniSevkForm(sevk s):this()//Düzenleme
        {
           ...
           // ActiveHasta = db.dosya.ToList().First(a =>a.dosyaid == db.sevkler.ToList().First(b =>b.sevktarihi == s.sevktarihi).dosyaID).hasta;
            //var test = db.sevk.ToList().Where(a => a.sevktarihi == s.sevktarihi).FirstOrDefault();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            { 
                ...
                //sevk sevk= db.sevk.ToList().Where(a=>ActiveSevk.sevktarihi==a.sevktarihi).FirstOrDefault();
            ...
            foreach (var islems in islemlerList)
            {
                ...
                //db.Entry(islems.personel).State = EntityState.Unchanged;
                //db.Entry(islems.islem).State = EntityState.Unchanged;
