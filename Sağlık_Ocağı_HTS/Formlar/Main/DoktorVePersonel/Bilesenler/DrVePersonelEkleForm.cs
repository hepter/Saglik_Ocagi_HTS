...
{
    public partial class DrVePersonelEkleForm : Sağlık_Ocağı_HTS.Formlar.DialogBox
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            switch (activeEklemeTürü)
            {
                case EklemeTürü.Doktor:
                    ...
                    entity.tckimlikno= Int64.Parse(maskedTextBox3.Text);
                    entity.birey= new birey();
                    entity.birey.tckimlikno = Int64.Parse(maskedTextBox3.Text);
                ...
                case EklemeTürü.Personel:
                    ...
                    entity2.tckimlikno= Int64.Parse(maskedTextBox3.Text);
                    entity2.birey= new birey();
                    entity2.birey.tckimlikno = Int64.Parse(maskedTextBox3.Text);
